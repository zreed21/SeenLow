 ...
 * Operator: Zach Reed d/b/a SeenLow
...
export function SupportNotice({ compact = false }: { compact?: boolean }) {
  return (
    ...
    >
      ...
      <span>
        <strong className="text-white">Returns & support:</strong> SeenLow handles every order question, return, and issue directly — reach us at{" "}
